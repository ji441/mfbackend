...
exports.deleteCustomerVideoPost = async (req, res) => {
  try {
    // 1. Check video if exist by videoPostId
    const videoPostId = req.params.videoPostId;
    ...
    // 2. get videoPost url and coverImage url
    ...
    // 3. delete videoPost from videoPost collection
    await VideoPost.deleteOne({ _id: videoPostId });

    // 4.  delete video from user documentation
